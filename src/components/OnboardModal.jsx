    ...
    switch (st) {
        ...
        return (
          <>
            <p className={styles.modalText}>
              You don't have a Wallet installed!
            </p>
          </>
        );
      ...
      case 1:
        return (
          <>
            <p className={styles.modalText}>
              You haven't connected your account to a Wallet!
            </p>
            <CustomButton
      ...
      case 2:
        return (
          <>
            <p className={styles.modalText}>
              You're on a different network. Switch to Canto.
            </p>
      ...
      case 3:
        return (
          <>
            <p className={styles.modalText}>
              Oops, you don't have tokens in your account
            </p>
          </>
        );
