const styles = {
  ...
  btn: 'px-4 py-2 rounded-lg bg-siteViolet w-fit text-black font-rajdhani font-bold',
  ...
  radio: 'bg-siteDimBlack text-white outline-none focus:outline-siteViolet p-4 rounded-md sm:max-w-[50%] max-w-full',
